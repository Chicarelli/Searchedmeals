...
<img style="width: 80%; margin: auto" src="./searched-meals-full-screen.PNG" alt="Imagem da Aplicação por Completa">
...
<img style="display: inline-block; align: center;" src="./component-listItem-responsividade.PNG" alt="Imagem do component ListItem Responsivo"/>
